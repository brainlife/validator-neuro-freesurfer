...
if not os.path.exists("secondary/surfaces"):
   os.makedirs("secondary/surfaces")
...
for label in labels:
    ...
    writer.SetFileName("secondary/surfaces/"+surf_name)
    writer.Write()

with open("secondary/surfaces/index.json", "w") as outfile:
